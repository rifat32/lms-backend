...
class BusinessController extends Controller
{
     ...
     *                 @OA\Property(property="email", type="string", format="email", example="contact@acme.test"),
     *                 @OA\Property(property="phone", type="string", example="+8801XXXXXXXXX"),
     *                 @OA\Property(property="registration_date", type="string", format="date", example="2025-01-01"),
     *                 @OA\Property(property="trail_end_date", type="string", format="date", example="2025-02-01"),
