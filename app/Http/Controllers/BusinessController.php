...
class BusinessController extends Controller
{
     ...
     *   summary="Update an existing business (files only for logo/image/background_image/images)",
     *   security={{"bearerAuth":{}}},
     *
     *   @OA\Parameter(
     *     name="id", in="path", required=true, description="Business ID",
     *     @OA\Schema(type="integer"), example=1
     *   ),
     *
     *   @OA\RequestBody(
     *     required=true,
     *     description="Send fields as multipart/form-data.",
     *     @OA\MediaType(
     ...
     *         @OA\Property(property="web_page", type="string", format="uri", example="https://acme.com"),
     ...
     *         @OA\Property(property="lat", type="number", format="float", example=23.7808875),
     *         @OA\Property(property="long", type="number", format="float", example=90.2792371),
     *         @OA\Property(property="currency", type="string", example="BDT"),
     *         @OA\Property(property="country", type="string", example="Bangladesh"),
     *         @OA\Property(property="city", type="string", example="Dhaka"),
     *         @OA\Property(property="postcode", type="string", example="1207"),
     ...
     *           type="string",
     *           format="binary",
     *           description="Image file only (jpg, jpeg, png, webp, avif, gif). Max 5MB."
     *         ),
     *         @OA\Property(
     *           property="image",
     *           type="string",
     ...
     *           property="images[]",
     *           type="array",
     *           description="Multiple image files. Use key images[] for each file.",
     ...
     *   ),
     *
     *   @OA\Response(response=200, description="Business updated successfully", @OA\JsonContent(
     *     @OA\Property(property="success", type="boolean", example=true),
     *     @OA\Property(property="message", type="string", example="Business updated successfully"),
     *     @OA\Property(property="data", type="object",
     *       @OA\Property(property="id", type="integer", example=1),
     *       @OA\Property(property="logo", type="string", example="http://yourapp.com/storage-proxy/business_1/business_1/logo123.png"),
     *       @OA\Property(property="image", type="string", example="http://yourapp.com/storage-proxy/business_1/business_1/cover.jpg"),
     *       @OA\Property(property="background_image", type="string", example="http://yourapp.com/storage-proxy/business_1/business_1/bg.jpg"),
     *       @OA\Property(property="images", type="array", @OA\Items(type="string", example="http://yourapp.com/storage-proxy/business_1/business_1/gallery1.jpg"))
     *     )
     *   )),
    ...
    public function updateBusiness(BusinessUpdateRequest $request, $id)
    {
        DB::beginTransaction();
        try {
